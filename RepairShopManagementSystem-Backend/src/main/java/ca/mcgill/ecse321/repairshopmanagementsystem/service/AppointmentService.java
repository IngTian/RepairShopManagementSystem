...
public class AppointmentService {
    ...
    /**
     * Make a payment to an appointment.
     *
     ...
     */
    @Transactional
    public Bill makePayment(Integer appointmentId, Integer amount) {
        ...
        if (appointment == null)
            throw new IllegalArgumentException("Appointment of the specified ID does not exist!");

        Bill payment = new Bill();
        payment.setIsPaid(true);
        payment.setPrice(amount);
        payment.setAppointment(appointment);
        appointment.getBill().add(payment);
